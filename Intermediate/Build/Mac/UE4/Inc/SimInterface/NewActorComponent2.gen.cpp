...
// Cross Module References
	...
	SIMINTERFACE_API UFunction* Z_Construct_UFunction_UNewActorComponent2_TestSystem();
...
// End Cross Module References
	void UNewActorComponent2::StaticRegisterNativesUNewActorComponent2()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "TestSystem", &UNewActorComponent2::execTestSystem },
	...
	struct Z_Construct_UFunction_UNewActorComponent2_TestSystem_Statics
	{
		struct NewActorComponent2_eventTestSystem_Parms
		{
			float input;
			float ReturnValue;
		};
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UNewActorComponent2_TestSystem_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(NewActorComponent2_eventTestSystem_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UNewActorComponent2_TestSystem_Statics::NewProp_input = { "input", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(NewActorComponent2_eventTestSystem_Parms, input), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNewActorComponent2_TestSystem_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNewActorComponent2_TestSystem_Statics::NewProp_ReturnValue,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNewActorComponent2_TestSystem_Statics::NewProp_input,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNewActorComponent2_TestSystem_Statics::Function_MetaDataParams[] = {
		{ "Category", "SimInterface" },
		{ "ModuleRelativePath", "Public/NewActorComponent2.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UNewActorComponent2_TestSystem_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNewActorComponent2, nullptr, "TestSystem", nullptr, nullptr, sizeof(NewActorComponent2_eventTestSystem_Parms), Z_Construct_UFunction_UNewActorComponent2_TestSystem_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNewActorComponent2_TestSystem_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UNewActorComponent2_TestSystem_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UNewActorComponent2_TestSystem_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UNewActorComponent2_TestSystem()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UNewActorComponent2_TestSystem_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNewActorComponent2_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UNewActorComponent2_TestSystem, "TestSystem" }, // 89076245
	...
	IMPLEMENT_CLASS(UNewActorComponent2, 801710391);
